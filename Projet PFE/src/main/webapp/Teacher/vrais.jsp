            ...
            <div class="content">
                <div class="row">
                    <div class="col-sm-4 col-3">
                        <h4 class="page-title">ADD QUIZ VRAIS_FAUX</h4>
                    </div>
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="quiz_blan.jsp" class="btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Quiz Blan</a>
                ...
                <form name="registre" action="addvrais.jsp">
        ...
        <div class="account-page">
            <div class="account-center">
                <div class="account-box">
                        ...
                        <div class="form-group">
                            <label>Reponse</label></div>
                            <div class="form-group">
                            <div class="form-check-inline">
											<label class="form-check-label">
												<input type="radio" name="rep" value="Vrais" class="form-check-input" required>Vrais
											</label>
										</div>
										<div class="form-check-inline">
											<label class="form-check-label">
												<input type="radio" name="rep" value="Faux" class="form-check-input" required>Faux
											</label>
										</div>
                        </div>
