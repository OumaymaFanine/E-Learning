                                                ...
                                                <div class="chat chat-right">
                                                    <div class="chat-body">
                                                        <div class="chat-bubble">
                                                           <label><%=session.getAttribute("m")%></label>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="navbar">
                                    <div class="user-details mr-auto">
                                        <div class="user-info float-left">
                                            ...
                                            <select id="nomchat" name="res" class="form-control" required >
                                    ...
                                    <div class="message-inner">
                                        ...
                                        <div class="message-area">
                                            <div class="input-group">
                                                <textarea class="form-control" name="mes" placeholder="Type message..."></textarea>
