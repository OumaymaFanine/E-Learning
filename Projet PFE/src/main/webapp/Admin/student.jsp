            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li  class="active">
                            <a href="student.jsp"><i class="fa fa-dashboard"></i> <span>Student</span></a>
                        </li>
						<li >
                            <a href="Teachear.jsp"><i class="fa fa-user-md"></i> <span>Teacher</span></a>
                        </li>
                        <li >
                            <a href="calendar.jsp"><i class="fa fa-user-md"></i> <span>calendar</span></a>
                        </li>
                        <li >
                            <a href="chat_room.jsp"><i class="fa fa-user-md"></i> <span>Chat</span></a>
                        </li>
				...
				<div class="row doctor-grid">
                    ...
                    <div class="col-md-4 col-sm-4  col-lg-3">
                        ...
                        <div class="profile-widget">
                            ...
                            <h4 class="doctor-name text-ellipsis"><%=rs.getString(5)%> <%=rs.getString(6)%></h4>
                            <div class="doc-prof"><%=rs.getString(4)%></div>
                            <div class="user-country">
                                <i class="fa fa-map-marker"></i> <%=rs.getString(12)%>, <%=rs.getString(11)%>
                            </div>
