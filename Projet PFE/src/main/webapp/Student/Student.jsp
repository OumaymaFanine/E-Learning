...
String qry="select * from etudiant where username='"+ session.getAttribute("username") +"' ";
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="user" type="text" value="<%=session.getAttribute("username")%>" required>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Email <span class="text-danger">*</span></label>
                                        <input class="form-control" value="<%=rs.getString(4)%>" name="email" type="email" required>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Niveau</label>
                                        <input class="form-control" value="<%=rs.getString(7)%>" name="nv" type="text"required>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Option</label>
                                        <input class="form-control" value="<%=rs.getString(8)%>" name="op" type="text" required>
                                    </div>
                                </div>
								<div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="cal-icon">
                                            <input type="text" value="<%=rs.getString(9)%>" name="dn" class="form-control datetimepicker" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                     ...
                                     <input type="text" value="<%=rs.getString(10)%>" name="di" class="form-control datetimepicker" required>
                                                                            </div>
                                </div>
                                <div class="col-sm-6">
									<div class="form-group gender-select">
										...
										<div class="form-check-inline">
											<label class="form-check-label">
												<input type="radio" name="gender" checked class="form-check-input" required><%=rs.getString(11)%>
											</label>
										</div>
									</div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
												<label>Address</label>
												<input name="ad" value="<%=rs.getString(12)%>" type="text" class="form-control " required>
									</div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
												<label>Ville</label>
												<input type="text" value="<%=rs.getString(13)%>" name="vi" class="form-control " required>
									</div>
                                </div>
                                <div class="col-sm-6">
									<div class="form-group">
