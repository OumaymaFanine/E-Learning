                                                ...
                                                <div class="chat chat-right">
                                                    <div class="chat-body">
                                                        <div class="chat-bubble">
                                                           <label><%=session.getAttribute("mms")%></label>
                                                        </div>
                                                    </div>
                                                </div>
...
String qry="select nom,prenom,id from Teacher";
                                ...
                                <div class="navbar">
                                    <div class="user-details mr-auto">
                                        <div class="user-info float-left">
                                            ...
                                            <select id="nomchat" name="resp" class="form-control" required >
                                    ...
                                    <div class="message-inner">
                                        ...
                                        <div class="message-area">
                                            <div class="input-group">
                                                <textarea class="form-control" name="mesage" placeholder="Type message..."></textarea>
